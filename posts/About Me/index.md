...
---
 ...
 2018년 2월 졸업을 하고 다른 직업을 찾기 위한 방황의 시기에 들어갑니다. 그때도 개발자가 후보에 있었지만 가장 먼저 한 일은 대학원을 나와 연구원이 되는 것이었습니다. 조경학과에 환경 분야를 다루는 연구실이 있었고 당시 교수님께서 저를 꽤나 마음에 들어하셨습니다. 물리를 잘하고 파이썬을 잘 다룬다는 이유때문이었습니다. 
...
학부생 시절부터 프로그래밍과 개발자에 대한 관심이 있었습니다. 대학교 3학년 때 쯤 수업에서 파이썬을 처음 접했고, 여름방학엔 위에서 언급한 대학원에서 진행한 파이썬 스터디에 참여 했습니다. 제 전공인 조경은 주민들의 이해관계, 디자인, 문화 등 논리로 설명되지 않는 요소들이 많았는데, 프로그래밍은 논리적으로 전개한대로 구현하기만 하면 돌아가니 너무 속이 시원했습니다! (물론 안돌아 갈때는... :sad: )

 그리고 어깨너머로 보는 개발자들의 세계도 멋져 보였습니다. 같은 대학생임에도 벌써부터 사회에 의미있는 것들을 만들어내는 대학생 개발자들을 보며 개발자는 무척 흥미로운 직업이라고 생 

 하지만 개발자로 진로를 바꾸기 까지 심리적 장벽이 조금 있었습니다. 인터넷에서 볼 수 있는 비전공자 개발자에 대한 부정적인 글들이었습니다. '학원 출신은 서류에서부터 거른다.', '몸값 저렴할 때 땔감처럼 쓰다가 버려진다.', '아무리 잘해봐야 한계가 있다.' 등의 글이었습니다. 이런 시선들 때문에 바로 개발자로 전향하지 못하고 이곳 저곳 방황했었습니다.

 방황하던 시기에 시도한게 모두 뜻대로 이루어지지 않자, 오기가 생겼습니다. '개발자가 돼서 그들이 맞나 틀리나 한 번 해보자!' 라는 생각이었습니다. 개발자로 일하고 있는 친구에게 몇 차례 조언을 구했습니다. 그 친구가 '그런 글들은 실력이 없는 사람들이 쓰는 푸념이다. 자기 주변에도 잘하고 인정받는 비전공자 개발자가 많다. 네가 그런 취급을 받게 된다면, 그건 실력이 없어서이지 비전공자여서가 아니다.'라는 친구의 조언에 힘입어 개발자의 세계로 들어서게 됩니다.
...
---
 ...
 고민끝에 국비지원 학원을 다니기 시작했고, 저는 굉장히 만족했습니다. 웹 개발의 시작과 끝을 얇고 빠르게 훑는 방식이어서 수업만 잘 이해해도 간단한 웹 서비스는 구현할 수 있었고, 더 깊게 파고들면 웬만한 학부 전공자보다 실무에 있어선 더 나을 것 같다고 생각합니다.
...
- 2018.02 ~ 2018.08, 열섬 
  - python을 사용한 ArcGIS라는 프로그램의 자동화를 맡았습니다. 비록 프로그래밍은 arcpy라는 라이브러리를 조합하는 정도였지만, 프로그래밍을 통해 눈에 보이는 무언가를 만들 수 있는 좋은 경험이었습니다.
- 2019.06~2019.07 Sagyo
  - Java, Oracle, jsp, Spring, Apache/Tomcat을 사용했습니다.
  - 소셜다이닝 웹 어플리케이션을 구현했습니다.
  - 자세한 사항은 여기를 참고해주세요.
- 2019.07~2019.08 TCA
...
- 2019.09~2020.03 인지소프트
  ...
  - 인지소프트에서 이미지 서버(금융권의 서류를 전산화 하는 것) 재구축 프로젝트, 전자문서 디지털 창구(요즘 은행에서 볼 수 있는 타블렛 화면기반 전자문서) 프로젝트를 진행했습니다.
...
제가 생각하는 저의 장점은 경쟁심이 강한 사람이라는 것입니다. 지금까지 제가 뭔가를 잘 했을땔 떠올려보면, 항상 열등감과 경쟁심을 느낄 때 였습니다. 한땐, 이런 저 스스로를 부정적으로 생각했었습니다. 뭔가 순수한 추진력으로 했으면 좋겠는데 다른 사람과의 비교를 통해 추진력을 얻는 저를 보면서 나는 다른 사람이 없으면 아무것도 아닌 놈인가 생각했습니다.

 하지만, 그 생각이 잘못된 것이었습니다. 당시 제가 열정을 울부짖는 자기계발서들의 클리셰에 빠져있어서 다른 생각을 하지 못했습니다. 수단만 정당하다면, 욕심이나 경쟁은 부리면 부릴수록 좋다는 것, 사람은 사람들과 있을 때 존재의 의미를 갖는다는 점들을 이해하고 나니, 제 성격이 장점이라고 생각하게 됐습니다.

 약점은 아직 기초 이론 지식이 부족하다는 것입니다. 이 부분은 몇몇 에러를 마주하면서 '이게 어떻게 동작하는지 더 깊게 알았으면  좋겠는데...'하는 부분에서 느꼇습니다. 이를 보완하기 위해 에러를 마주하면 단순히 에러를 해결하는게 아닌, 원인을 더 찾아보려고 노력하고 있습니다. 또한, 따로 이론지식을 학습하고 있습니다.
...
개발자로서의 저의 최종 목표는 한 웹 서비스의 모든 부분을 파악하고 지휘할 수 있는 실력을 갖춘 뒤 저의 회사를 설립하는 것입니다. 언제가 될 지, 어떤 사업 분야가 될 진 모르지만, 꼭 저의 회사를 만들고 싶습니다.
 ...
 이를 이루기위한 단기적인 목표는 웹 백엔드를 익히는 것입니다.
...
- 
 ...
 하지만, 다음과 같은 구절엔 동의하지 않습니다.

- 초인 어쩌구

 개인적으로, 인간은 서로간의 도움이 필요한 나약한 동물이라고 생각합니다.

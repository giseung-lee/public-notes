...
- &nbsp;프로젝트 카테고리에 넣어도 될 지 고민했지만 그래도 나름 조경 재밌게 했으니까 기념하여 졸업작품 정도는 남겨도 되지 않을까... 합니다!

- &nbsp;우선 프로젝트는 1인으로 진행 됐습니다. 그 동안 매번 팀 프로젝트만 시키다가 졸업 작품은 개인 프로젝트 시키시는 교수님.. 역시 강하게 크는 맛이 있습니다.
...
- &nbsp;판넬 하나로 자세히 보려면 적어도 100MB 이미지는 업로드해야 하기 때문에 조각조각 떼 놓은 슬라이드를 보며 설명드리겠습니다.
...
- &nbsp;대상지는 충남 보령시에 있는 천북 굴단지 일대입니다. 설날에  굴 먹으러 갔다가 대상지의 잠재성에 비해 아직 개발이 안 된 것 같아 눈여겨 보고 있었습니다.

- 조경학과에서의 꿀팁은 교수님이 모르는 곳을 대상지로 삼는 것입니다. 교수님이 잘 아는 곳을 대상지로 삼으면 교수님의 지식과 편견에  맞서야 합니다.

- &nbsp;천북 굴단지 자체는 위사진 왼쪽에 보이는 네모 상자 안에 있는 작은 지역이지만, 프로젝트 대상지는 천북 굴단지와 홍성호, 홍성 방조제를 포함합니다.
...
{: .p_img}
![site2.jpg]({{ site.imgbase }}The_Oyster_Mine/site2.jpg){: .center }<small>쌓아 놓은 굴들. 모두 하루에 판매되는 양이다.</small>
...
- &nbsp;이 부분이 가장 재미있는 부분입니다. 사실 천북 굴단지는 위 사진에 보이는 것처럼 홍성호 안쪽에 있었습니다. 

- &nbsp;천북 굴단지가 생성되고 발전하던 **1990년대 ~ 2001년 까진 홍성호 안쪽에 갯벌이 활성화 되어 있어 바로 앞에서 갯굴을 직접 양식하고 채취하고 판매**했습니다.

- &nbsp;하지만 2001년 농업 용수 확보를 목표로 홍성 방조제가 앞에 세워집니다. **갯벌은 당연히 기능을 잃게 되고 천북 굴단지는 홍성 방조제 앞쪽으로 옮겨 오게 됩니다.**

- &nbsp;그래도 2007년 까진 생산량이 줄었지만, 방조제 앞에서 직접 굴을 양식해 판매했습니다. 하지만 2007년, 태안 기름 유출 사고가 일어납니다. **이후 자체 양식은 불가능해지지만 이미 유명해져있는 천북에 찾아오는 손님을 상대하기 위해 통영에서 굴을 받아 판매하는 아이러니한 유통구조가  형성됩니다.**
  - &nbsp;뉴스 및 방송에서 천북 굴단지에서 서해안 굴이 아닌 통영굴을 쓴다는 것이 몇번 나왔지만, 천북 굴단지를 찾는 많은 사람들은 천북에서 직접 재배한 굴인줄 알고 있었습니다.
...
- &nbsp;홍성 방조제로 확보한 농업용수는 2001년 이래 한 번도 사용되지 않았습니다. 
  ...
  - &nbsp;가축 농가에서 나온 분뇨들이 모두 홍성호로 흘러들어 나가지 못하고 쌓이기 때문에 홍성호에 저장해 놓은 물은 농업용수로도 못쓰는 수준이었습니다.
...
- &nbsp;천북 굴단지의 최대 이슈인 홍성 방조제는 이미 한국농어촌공사와 충청남도 사이의 핫한 이슈였습니다.
  - 한국농어촌공사 측의 입장은 다음과 같습니다. 
    - 농업 용수 확보의 어려움
    - 그간 투입된 2000억 원의 사업비 매몰
  - 이에 충청남도 측은 다음과 같은 입장을 가지고 있었습니다.
    - 영농기에 필요한 11만 톤의 물은 금강에서 끌어올 수 있다.
    - 2000억 원 중 방조제 관련 비용 750억 원만 매몰되는 것. 기타 제반시설은 사용 가능.
    - 해수유통을 시켜 갯벌 생태계를 회복하는게 환경적으로도, 경제적으로도 이득이다.
    - 해양수산부, 환경부 역시 역간척 사업에 찬성한다.
- 태안 기름유출 사건 이후, 이제 다시 굴 양식이 가능할 정도가 됐다는 연구 논문은 충분했습니다.

{: .p_img}
![5_rice.jpg]({{ site.imgbase }}The_Oyster_Mine/5_rice.jpg){: .center }

- 국내에서 쌀은 계속 초과 공급 상태입니다. 

- 또한, 쌀의 공급, 수요, 소비량 모두 줄어드는 추세입니다. 농업 용수를 추가할 필요가 없습니다.

{: .p_img}
![6_farm.jpg]({{ site.imgbase }}The_Oyster_Mine/6_farm.jpg){: .center }

- &nbsp;홍성 방조제가 만들어 졌어도 인근 농지는 큰 변화가 없습니다. 오른쪽은 1983년 항공사진이며, 갯벌이 형성되어 있음을 볼 수 있습니다. 

- &nbsp;그리고, 오른쪽 사진의 갯벌 부분을 자세히 보시면 검정 얼룩이 보이는데 이 검정 얼룩들이 굴 양식장입니다.
...
- &nbsp;해양조사원의 해수면 높이 데이터 3년치를 토대로 상황에 따른 해수면을 지도에 그려 보았습니다. 
  ...
  - 해당 정보는 하구 복원 후, 생태적으로 굴이 서식할 수 있는 영역과 염생 식물이 서식 가능한 영역을 구하는데 사용됐습니다.

- &nbsp;오른쪽 위는 Surface water Modeling System라는 소프트웨어를 이용한 분석입니다. 하구 복원을 위해 홍성 방조제를 열어 뒀을 때 유속이 빨라 위험해지는 구간을 찾아 설계에 사용했습니다.
...
- &nbsp;본 프로젝트으로 해외 ASLA([American Society of Landscape Architects](https://www.asla.org/)) 공모전에 참여했기 때문에 교수님께서 생각보다 과감한 컨셉을 도전해도 된다고 하셨습니다.
...
{: .p_img}
![concept3.jpg]({{ site.imgbase }}The_Oyster_Mine/concept3.jpg){: .center }<small>Kate Orff의 Oyster-Tecture - 굴의 생애주기를 설계에 녹여냈다. 대단하다..</small>


{: .p_img}
![problem.jpg]({{ site.imgbase }}The_Oyster_Mine/problem.jpg){: .center }<small>현재 천북 굴단지는 도로가 공원, 상가를 막고 있다.</small>


{: .p_img}
![concept4.png]({{ site.imgbase }}The_Oyster_Mine/concept4.png){: .center }<small>이런 곳처럼 상가가 바다와 만났으면 좋겠다고 생각했다.</small>


{: .p_img}
![concept5.png]({{ site.imgbase }}The_Oyster_Mine/concept5.png){: .center }<small>아예 콘크리트로 도로에 뚜껑을 덮는 설계안도 있었다.</small>
...
{: .p_img}
![poll.png]({{ site.imgbase }}The_Oyster_Mine/poll.png){: .center }<small>양식장의 기둥이 George Hargreaves의 Byxbee Park를 떠올리게도 했다.</small>


{: .p_img}
![oyster_mine.png]({{ site.imgbase }}The_Oyster_Mine/oyster_mine.png){: .center }<small>굴을 카트에 싣고 다니면 어떨까? 생각을 했다..</small>


{: .p_img}
![concept1.jpg]({{ site.imgbase }}The_Oyster_Mine/concept1.jpg){: .center }<small>끔찍한 혼종.. 스케치 해보고 바로 접었다.</small>
...
- &nbsp;정리 하다보니까 레퍼런스까지 모조리 정리하고 싶었으나 레퍼런스까지 정리하려면 프로젝트 폴더를 정말 탈탈 털어야 하기 때문에 다음에...